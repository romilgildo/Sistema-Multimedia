...
public class KernelProducer {
    ...
    final static int TYPE_ENFOQUE_3x3 = 1;
    final static int TYPE_RELIEVE_3x3 = 2;
    final static int TYPE_LAPLACIANA_3x3 = 3;    
    final static int TYPE_BINOMIAL_3x3 = 4; // lo pongo al final para que no entre en el filtro de la Ventana principal
